...
class condGANTrainer(object):
    def __init__(self, output_dir, data_loader, n_words, ixtoword):
        if cfg.TRAIN.FLAG:
            ...
            self.writePath1 = output_dir + '/Model/gresults.txt'
            self.writePath2 = output_dir + '/Model/dresults.txt'
            self.writePath3 = output_dir + '/Model/results.txt'
        ...
        for epoch in range(start_epoch, self.max_epoch):
            ...
            while step < self.num_batches:
                ...
                if gen_iterations % 100 == 0:
                    print(D_logs + '\n' + G_logs)
                    with open(self.writePath1, 'a') as f:
                        f.write(str(epoch) + ' ' + str(step) + ' ' + G_logs + "\n")
                    with open(self.writePath2, 'a') as f:
                        f.write(str(epoch) + ' ' + str(step) + ' ' + D_logs + "\n")
                # save images
            ...
            print('''[%d/%d][%d]
                  ...
                  % (epoch, self.max_epoch, self.num_batches,
                     ...
                     end_t - start_t))
            finalresultsasText = str(epoch) + ' ' + str(self.num_batches) + ' ' + str(errD_total.item()) + ' ' + str(errG_total.item()) + ' ' + str(end_t - start_t)
            with open(self.writePath3, 'a') as f:
                f.write(finalresultsasText + "\n")
